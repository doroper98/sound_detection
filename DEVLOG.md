...
- 검증 준비: 서로 다른 좌우 크기·피크/마지막 샘플 보존·여러 샘플률·무음/짧은 버퍼·잘못된 입력 테스트 4개 추가(총 Swift 31개). 실제 Canvas의 두 채널/무음/지연/중지·백그라운드 UI 검증(총 15개)과 기기 빌드·화면 검토 예정. 빌드 번호 4, 웹 버전 0.4.0 유지.
