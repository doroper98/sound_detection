...
**iPhone 네이티브 입력:** 빌드 12는 iOS 26 공간 오디오(FOA) 4채널의 방향 열지도·주파수를 계속 갱신하며, 기본 OFF인 연구 녹음을 켜면 원음·폰 자세·시각·계산 결과를 ZIP 하나로 공유할 수 있습니다. 별도 스테레오 파형과 최근 진단 5개 보관도 제공합니다. 빌드 10 사용자 보고서에서 FOA와 카메라 병행 수신은 확인됐지만, 카메라 축 대응·실제 방향 정확도는 미검증이며 거리는 표시하지 않습니다. 새 경로는 6단계 크기 보정을 요구하지 않습니다. [연구 ZIP 보내기](docs_canonical/GROUND_TRUTH_PROTOCOL.md) · [빌드 12 소프트웨어 검증](docs/reports/2026-09-24-native-build12-verification.json) · [프로젝트와 설치 기반 안내](native/ios/README.md)
