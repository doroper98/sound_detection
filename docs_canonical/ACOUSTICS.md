...
2026-09-23: [iPhone 가능성 재진단](NATIVE_LOCALIZATION_FEASIBILITY.md)에 실제 코드의 지연 추정 차이, 미교정 임계값, 반사/고정 처리 지연 반례를 기록했다. 아래 가상 모델의 성공은 내장 Stereo의 물리 TDOA 또는 기기 정확도를 입증하지 않는다.
